    ...
    class TestViewController: UIViewController {
        ...
        private func createActivitySection() -> UIView {
            ...
            let activities = [
                (
                    "Pushed to main", "SnapshotTestingHEIC", "2h ago",
                    UIColor(red: 0.2, green: 0.8, blue: 0.4, alpha: 1.0)
                ),
                (
                    "Opened PR #42", "swift-composable-architecture", "5h ago",
                    UIColor(red: 0.35, green: 0.45, blue: 0.95, alpha: 1.0)
                ),
                (
                    "Starred repository", "Alamofire/Alamofire", "1d ago",
                    UIColor(red: 0.95, green: 0.75, blue: 0.3, alpha: 1.0)
                ),
        ...
        private func createActivityRow(action: String, target: String, time: String, color: UIColor, showDivider: Bool)
            -> UIView
        {
            let container = UIView()
            container.translatesAutoresizingMaskIntoConstraints = false
